...
<div class="containerWrapper">
    <div class="container3">
        <div id="power2">
            ...
            <br>
            <form method="GET" autocomplete="on" action="{{ url('adminusersearchid', [], true) }}">
            ...
            <br>
            <form method="GET" autocomplete="on" action="{{ url('adminusersearchname', [], true) }}">
            ...
            <br>
            <form method="GET" autocomplete="on" action="{{ url('adminuserdate', [], true) }}">
                <div class="container" style="height: 50px; width: 500px">
                    <div class="input-group mb-3">
