...
<div class="containerWrapper">
    <div class="container3">
        <div id="power2">
            ...
            <br>
            <form method="GET" action="{{ secure_url(route('adminusersearchid')) }}">
            ...
            <br>
            <form method="GET" action="{{ secure_url(route('adminusersearchname')) }}">
            ...
            <br>
            <form method="GET" action="{{ secure_url(route('adminuserdate')) }}">
                <div class="container" style="height: 50px; width: 500px">
                    <div class="input-group mb-3">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="POST" action="{{ secure_url(route('adminuserupdate', ['id' => $user->id])) }}">
                                        @csrf
                                        @method('PUT')
                    ...
                    <div class="modal fade" id="staticBackdrop3_{{$user->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel3" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ secure_url(route('adminremoveuser', ['id' => $user->id])) }}">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-footer">
