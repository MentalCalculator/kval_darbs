...
<div class="containerWrapper">
    <div class="container1">
        ...
        <form method="GET" action="{{ secure_url(route('purchasessearch')) }}">
        ...
        <form method="GET" action="{{ secure_url(route('purchasesdate')) }}">
            <div class="input-group mb-3">
            ...
            <div class="modal-dialog modal-dialog-centered" style="width: 800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ secure_url(route('purchasecreate')) }}">
                            @csrf
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form method="POST" action="{{ secure_url(route('productupdate', ['id' => $products->id])) }}">
                                                    @csrf
                                                    @method('PUT')
                                ...
                                <div class="modal fade" id="staticBackdrop3_{{$products->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel3" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ secure_url(route('removeproduct', ['id' => $products->id])) }}">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-footer">
                    ...
                    <div class="modal fade" id="staticBackdrop4_{{$purchase->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel4" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ secure_url(route('removepurchase', ['id' => $purchase->id])) }}">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success" data-bs-dismiss="modal">No</button>
