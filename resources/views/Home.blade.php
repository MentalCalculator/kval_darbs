...
<div class="containerWrapper">
    <div class="container1">
        ...
        <form method="GET" autocomplete="on" action="{{ url('purchasessearch', [], true) }}">
        ...
        <form method="GET" autocomplete="on" action="{{ url('purchasesdate', [], true) }}">
            <div class="input-group mb-3">
            ...
            <div class="modal-dialog modal-dialog-centered" style="width: 800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" autocomplete="on" action="{{ url('purchasecreate', [], true) }}">
                            @csrf
                    ...
                    <div class="modal fade" id="staticBackdrop4_{{$purchase->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel4" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <form method="POST" autocomplete="on" action="{{ url(route('removepurchase', ['id' => $purchase->id], ['secure' => true]) }}">
                                    @csrf
                                    @method('DELETE')
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-success" data-bs-dismiss="modal">No</button>
