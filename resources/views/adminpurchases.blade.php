...
<div class="containerWrapper">
    <div class="container1">
        ...
        <form method="GET" action="{{ secure_url(route('adminpurchasesearchid')) }}">
        ...
        <form method="GET" action="{{ secure_url(route('adminpurchasesearchuserid')) }}">
            <div class="input-group mb-3">
        ...
        <form method="GET" action="{{ secure_url(route('adminpurchasesdate')) }}">
            <div class="input-group mb-3">
