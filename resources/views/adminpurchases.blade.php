...
<div class="containerWrapper">
    <div class="container1">
        ...
        <form method="GET" autocomplete="on" action="https://tomskd.lat/adminpurchasesearchid">
        ...
        <form method="GET" autocomplete="on" action="https://tomskd.lat/adminpurchasesearchuserid">
            <div class="input-group mb-3">
        ...
        <form method="GET" autocomplete="on" action="https://tomskd.lat/adminpurchasesdate">
            <div class="input-group mb-3">
