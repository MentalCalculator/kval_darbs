    ...
    <div class="container3">
        <div id="power2">
            ...
            <div class="summary-box" id="ProductsSummary">
                ...
                <br>
                <form method="GET" autocomplete="on" action="{{ secure_url(route('adminproductssearchname')) }}">
                ...
                <br><br>
                <form method="GET" autocomplete="on" action="{{ secure_url(route('adminproductssearchuserid')) }}">
                    <div class="container" style="height: 20px; width: 500px">
                        <div class="input-group mb-3">
                ...
                <br><br>
                <form method="GET" autocomplete="on" action="{{ secure_url(route('adminproductsdate')) }}">
                    <div class="container" style="height: 20px; width: 500px">
                        <div class="input-group mb-3">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" autocomplete="on" action="{{ secure_url(route('adminproductupdate', ['id' => $product->id])) }}">
                                            @csrf
                                            @method('PUT')
                                            <div class="input-group mb-3">
                        ...
                        <div class="modal fade" id="staticBackdrop3_{{$product->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel3" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" autocomplete="on" action="{{ secure_url(route('adminremoveproduct', ['id' => $product->id])) }}">
                                        @csrf
                                        @method('DELETE')
                                        <div class="modal-footer">
